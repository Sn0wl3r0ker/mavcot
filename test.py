...
def parse_args():
  parser = argparse.ArgumentParser(description="Send CoT UDP packets for FreeTAKServer testing")
  parser.add_argument("--ip", default="192.168.88.131", help="Destination IP (unicast or multicast)")
  parser.add_argument("--port", type=int, default=8087, help="Destination UDP port")
